...
> ⚠️ **HISTORICAL**：2026-07-09 起由 `v2-single-track-plan.md` 取代；批1–8及香港生产切换已于 2026-07-24 完成。P5（迁移）作废，旧 v1 数据改为离线归档；D9 的 additive-only 约束随 v1 拆除失效。P0–P4 的决策记录（D1–D12）与验收门仍为有效历史与技术依据，现状以 `docs/standard/STATUS.md` 为准。
>
