...
> ⚠️ **2026-07-09 起部分取代**：用户确认 v1 试运行数据可弃后，**P5（迁移）作废、P6（切换）升级为完全拆除**，后续工程路线以 **`docs/v2-single-track-plan.md`**（v1 单轨化：批0–批7）为准；D9 的 additive-only 约束随 v1 拆除失效。P0–P4 的决策记录（D1–D12）与验收门仍为有效历史与技术依据。
>
