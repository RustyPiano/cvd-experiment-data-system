...
from app.api.v1.endpoints.setup_method_templates import router as setup_method_templates_router
...
api_v1_router.include_router(setup_method_templates_router)
