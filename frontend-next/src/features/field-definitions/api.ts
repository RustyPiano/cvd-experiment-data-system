...
export function getFieldDefinition(
  ...
  return apiRequest<FieldDefinitionRead>(
    `/api/v1/field-definitions/${fieldId}`,
    {
      token: accessToken,
    },
  )
...
export function updateFieldDefinition(
  ...
  return apiRequest<FieldDefinitionRead>(
    `/api/v1/admin/field-definitions/${fieldId}`,
    {
      method: 'PATCH',
      body: data,
      token: accessToken,
...
export function deactivateFieldDefinition(
  ...
  return apiRequest<void>(
    `/api/v1/admin/field-definitions/${fieldId}/deactivate`,
    {
      method: 'POST',
      token: accessToken,
    },
...
export function reactivateFieldDefinition(
  ...
  return apiRequest<void>(
    `/api/v1/admin/field-definitions/${fieldId}/reactivate`,
    {
      method: 'POST',
      token: accessToken,
    },
