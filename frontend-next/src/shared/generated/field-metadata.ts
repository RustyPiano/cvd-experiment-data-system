...
export const experimentModules: Record<string, FieldMetadata[]> = {
  ...
  process_steps: [
    ...
    {
      key: 'pressure_system',
      labelZh: '反应压力条件与工作绝对压力',
      labelEn: 'Reaction pressure conditions and working absolute pressure',
      input: '下拉+数值',
      unit: 'Pa',
      ...
      validation: {
        gt: 0,
        require_value: false,
        require_value_options: ['low_pressure', 'ultra_high_vacuum'],
        require_option: true,
        option_ranges: {
    ...
    },
    {
      ...
      unit: '℃·℃/min',
      options:
        '{method: 随炉冷却|开盖冷却|移炉快速冷却|受控降温|其他, lid_open_temperature_C?, cooling_rate_C_per_min?, method_other?}',
      validation: null,
      requirement: {
        raw: '条件必填(反应条件记录)',
        level: 'conditional_required',
