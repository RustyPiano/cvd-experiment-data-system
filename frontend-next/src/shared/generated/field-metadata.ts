...
export const experimentModules: Record<string, FieldMetadata[]> = {
  ...
  precursors: [
    ...
    },
    {
      ...
      placeholderEn: 'Enter a value',
      helpZh:
        '选择物料批次后自动带出；如需修改，请在“基础资料维护”中追加物料版本。',
      helpEn:
        'Filled from the selected frozen lot snapshot; create a new lot version in Reference data maintenance to change it.',
    },
    {
      key: 'phase_state',
      labelZh: '相态',
    ...
    },
    {
      ...
      unit: null,
      options:
        '{type: 直接加载|熔融凝固|压片|旋涂|退火|研磨|其他, other_name?, parameters: 具名参数对象}',
      validation: null,
      requirement: {
        raw: '推荐',
        level: 'recommended',
    ...
    },
    {
      ...
      placeholderZh: '请输入',
      placeholderEn: 'Enter a value',
      helpZh: '以所在温区热电偶为 0 mm；沿气流方向，上游填负值，下游填正值。',
      helpEn:
