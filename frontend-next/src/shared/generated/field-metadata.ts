...
export interface CharacterizationConditionField {
  ...
  conditional_validation?: Array<{
    ...
    validation: { ge?: number; gt?: number; le?: number; lt?: number }
  }>
  when?: Record<string, string[]>
...
export const substrateOrientation: {
  format: string
  sources: string[]
  max_length: number
  statuses: string[]
  ...
  sapphire_plane_names: Record<string, string>
  sapphire_name_suffixes: string[]
} = {
  format:
    '圆括号内三个或四个整数，空格分隔，负指数用负号；四指数满足 h+k+i=0；不得全零；不把晶向方括号转换为晶面。',
  max_length: 128,
  statuses: ['not_provided', 'amorphous', 'polycrystalline', 'supplier_cut'],
  presets: {
    sapphire_al2o3: ['(0 0 0 1)', '(1 1 -2 0)', '(1 0 -1 0)', '(1 0 -1 2)'],
    sio2_si: ['(1 0 0)', '(1 1 0)', '(1 1 1)'],
    mica: ['(0 0 1)'],
    cu_foil: ['(1 0 0)', '(1 1 0)', '(1 1 1)'],
    au_foil: ['(1 0 0)', '(1 1 0)', '(1 1 1)'],
    'h-BN': ['(0 0 0 1)'],
  },
  index_counts: {
    sapphire_al2o3: [4],
  ...
  sapphire_plane_names: {
    '(0 0 0 1)': 'c',
    '(1 1 -2 0)': 'a',
    '(1 0 -1 0)': 'm',
    '(1 0 -1 2)': 'r',
  },
  sapphire_name_suffixes: ['', '面', 'plane'],
  sources: [
    'https://dictionary.iucr.org/Miller_indices',
    'https://journals.iucr.org/j/services/notesforauthors.html',
    'https://www.sciencedirect.com/science/article/pii/S0039602810001780',
    'https://www.tedpella.com/vacuum_html/Substrates_Supports_Wafers_Slides.aspx',
    'https://www.sciencedirect.com/science/article/pii/S0022024814003893',
  ],
}

export const omConfiguration: OpticalConfigurationSpec = {
  max_entries: 50,
  sections: {
    objectives: {
      label_zh: '物镜',
    ...
    cameras: {
      ...
      label_en: 'Cameras',
      name_field: 'detector',
      fields: ['image_color_mode', 'detector_gain', 'binning'],
      required: ['image_color_mode'],
      adjustable: [
        'detector_gain',
        'white_balance_mode',
    ...
    optics: {
      label_zh: '光学配置',
      label_en: 'Optical configurations',
      fields: [
        'optical_path',
        'contrast_method',
      ...
      required: ['optical_path', 'contrast_method', 'illumination_source'],
      adjustable: [
        'illumination_setting',
        'aperture_setting',
        'incident_polarization_angle_deg',
    ...
    scales: {
      ...
      references: ['objectives', 'cameras', 'optics'],
      adjustable: [],
    },
  },
  preset_fields: [
...
export const ramanConfiguration: OpticalConfigurationSpec = {
  ...
  sections: {
    lasers: {
      label_zh: '激光',
      label_en: 'Lasers',
      fields: ['laser_wavelength_nm', 'power_setting_unit'],
      required: ['laser_wavelength_nm', 'power_setting_unit'],
      adjustable: [],
    },
    objectives: {
      label_zh: '物镜/探头',
  ...
  notes:
    'Raman目录存于capabilities[].configuration.raman，复用OM具名目录结构；光谱配置引用适用激光。显微物镜登记倍率、NA、介质，探头不填物镜参数。原始数据的scan_file_id与variable_conditions记录序列来源与变动字段；变动字段不重复保存一个标量。power_setting/unit是仪器设置，sample_power_mW为样品处测值。file_intensity_units按文件保存强度单位。旧excitation_power字段保留历史语义。',
}
...
export const experimentModules: Record<string, FieldMetadata[]> = {
  ...
  target_product: [
    ...
    },
    {
      ...
      input: '下拉',
      unit: null,
      options: '片/膜状·带状·线状·管状·棒状·颗粒状·块状·其他',
      validation: null,
      requirement: {
        raw: '选填',
        level: 'optional',
    ...
    },
    {
      ...
      unit: null,
      options:
        '三角形·截角三角形·六边形·四边形（矩形/平行四边形/菱形）·其他多边形·圆形/椭圆形·星形/多裂片状·枝晶状·不规则·其他',
      validation: null,
      requirement: {
        raw: '选填',
        level: 'optional',
    ...
    {
      key: 'dimensional_form_other',
      labelZh: '其他目标形态',
      labelEn: 'Other target form',
      input: '文本',
      unit: null,
      options: null,
      validation: null,
    ...
    {
      key: 'in_plane_outline_other',
      labelZh: '其他目标轮廓',
      labelEn: 'Other target outline',
      input: '文本',
      unit: null,
      options: null,
      validation: null,
  ...
  equipment: [
    ...
    {
      key: 'field_device_other_names',
      labelZh: '其他附加能力',
      labelEn: 'Other additional capabilities',
      input: '文本数组',
      unit: null,
      options: null,
      validation: null,
  ...
  substrates: [
    ...
    },
    {
      ...
      labelZh: '标称晶面取向（来自批次）',
      labelEn: 'Nominal crystal plane (from lot)',
      input: '文本',
      unit: null,
      options: '规范晶面指数或明确的未知/非晶/多晶状态',
      validation: null,
      requirement: {
        raw: '选填（批次有明确规格时只读带出）',
        level: 'optional',
    ...
    },
    {
      key: 'polish',
      labelZh: '抛光状态（来自批次）',
      labelEn: 'Polish (from lot)',
      input: '文本',
      unit: null,
      options: '单面抛/双面抛/未抛光/未知',
      validation: null,
      requirement: {
        raw: '选填（来自批次）',
        level: 'optional',
  ...
  process_steps: [
    ...
    },
    {
      key: 'field_params',
      labelZh: '附加能力使用记录',
      labelEn: 'Additional capability use',
      input: '实际外场数组',
      unit: '按参数',
      options:
        '{field_type: 等离子体|光|电|其他, start_min, end_min, parameters: 等离子体[power_W, gas_species, pressure_Pa]；光[wavelength_nm, power_mW或irradiance_mW_cm2, source_distance_mm]；电[voltage_V或field_strength_V_cm, electrode_gap_mm, direction]；其他[capability_name, 至少一个具名参数]；other_parameters?}',
      validation: null,
      requirement: {
        raw: '选填',
        level: 'optional',
...
export const entities: Record<string, FieldMetadata[]> = {
  material_lot: [
    ...
    },
    {
      key: 'quartz_type',
      labelZh: '▸衬底·石英类型',
      labelEn: 'Substrate · quartz type',
      input: '下拉',
      unit: null,
      options: '石英单晶·熔融石英／石英玻璃·未知／供应商未提供',
      validation: null,
      requirement: {
        raw: '选填(石英；填写晶面前明确类型)',
        level: 'optional',
    ...
    {
      key: 'substrate_crystal_plane',
      labelZh: '▸衬底·标称晶面取向',
      labelEn: 'Substrate · nominal crystal plane',
      input: '下拉+其他',
      unit: null,
      options:
        '未知／供应商未提供·非晶，不适用·多晶，无单一取向·供应商切型·其他',
      validation: null,
      requirement: {
        raw: '选填',
        level: 'optional',
      ...
      r0: false,
      group: null,
      placeholderZh: '请选择晶面或取向状态',
      placeholderEn: 'Select a plane or orientation status',
      helpZh:
        '按供应商规格选择；其他晶面填写如 (1 0 0) 或 (1 1 -2 0)，负指数用负号。偏切单独记录。',
      helpEn:
        'Use the supplier specification. Enter other planes as (1 0 0) or (1 1 -2 0), using minus signs. Record miscut separately.',
    },
    {
      key: 'substrate_cut_spec',
      labelZh: '▸衬底·供应商切型原文',
      labelEn: 'Substrate · supplier cut specification',
      input: '文本',
      unit: null,
      options: null,
      validation: null,
    ...
    {
      key: 'substrate_polish',
      labelZh: '▸衬底·抛光状态',
      labelEn: 'Substrate · polish',
      input: '下拉',
      unit: null,
      options: '单面抛·双面抛·未抛光·未知／供应商未提供',
      validation: null,
      requirement: {
        raw: '选填',
        level: 'optional',
...
export const optionLabelsZh: Record<string, string> = {
  single_crystal_quartz: '石英单晶',
  fused_silica: '熔融石英／石英玻璃',
  not_provided: '供应商未提供',
  amorphous: '非晶，不适用',
  polycrystalline: '多晶，无单一取向',
  supplier_cut: '供应商切型',
  unpolished: '未抛光',
...
export const optionLabelsEn: Record<string, string> = {
  single_crystal_quartz: 'Single-crystal quartz',
  fused_silica: 'Fused silica / quartz glass',
  not_provided: 'Unknown / not provided',
  amorphous: 'Amorphous — not applicable',
  polycrystalline: 'Polycrystalline — no single orientation',
  supplier_cut: 'Supplier cut specification',
  ...
  lateral_junction: 'Lateral junction',
...
export const optionCodes: Record<string, string> = {
  石英单晶: 'single_crystal_quartz',
  '熔融石英／石英玻璃': 'fused_silica',
  '未知／供应商未提供': 'not_provided',
  '非晶，不适用': 'amorphous',
  '多晶，无单一取向': 'polycrystalline',
  供应商切型: 'supplier_cut',
  未抛光: 'unpolished',
...
export const fieldOptionCodes: Record<string, Record<string, string>> = {
  ...
  in_plane_outline: {
    其他多边形: 'other_regular_polygon',
    枝晶状: 'dendritic_fractal',
    三角形: 'triangle',
...
> = {
  spectral_peaks: {
    ...
    structured_schema: {
      ...
      required: ['status', 'position_unit', 'peaks'],
      properties: {
        status: {
...
export const characterizationProfiles: Record<string, CharacterizationProfile> =
  {
    optical_microscopy: {
      ...
      raw_file_guidance_zh: '上传原始图像或已登记的原生采集文件。',
      ...
      condition_fields: [
        ...
        },
        {
          ...
          label_zh: '记录方式',
          label_en: 'Observation type',
          value_type: 'select',
          options: [
            {
              value: 'visual',
              label_zh: '目视观察',
              label_en: 'Visual observation',
            },
            {
              value: 'digital',
              label_zh: '数字图像',
              label_en: 'Digital image',
            },
          ],
        },
        {
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              label_zh: '相衬',
              label_en: 'Phase contrast',
            },
            {
              value: 'fluorescence',
              label_zh: '荧光',
              label_en: 'Fluorescence',
            },
            {
              value: 'other',
              label_zh: '其他',
        ...
        {
          key: 'contrast_method_other',
          label_zh: '其他成像方式',
          label_en: 'Other contrast method',
          value_type: 'text',
          validation: {
            max_length: 128,
          },
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              value: 'one_shot',
              label_zh: '一次自动后锁定',
              label_en: 'One-shot auto / locked',
            },
            {
              value: 'continuous_auto',
              label_zh: '连续自动',
              label_en: 'Continuous auto',
            },
          ],
          when: {
            observation_mode: ['digital'],
        ...
        {
          key: 'image_color_mode',
          label_zh: '采集颜色模式',
          label_en: 'Image color type',
          value_type: 'select',
          options: [
            {
              value: 'color',
        ...
        {
          key: 'white_balance_settings',
          label_zh: '白平衡参数',
          label_en: 'White balance configuration / RGB gains',
          value_type: 'text',
          validation: {
            max_length: 128,
          },
        ...
        {
          key: 'white_balance_temperature_K',
          label_zh: '白平衡色温',
          label_en: 'Reported white balance color temperature',
          value_type: 'number',
          unit: 'K',
          when: {
            white_balance_mode: [
        ...
        {
          key: 'white_balance_reference',
          label_zh: '白平衡参考对象/文件',
          label_en: 'White balance reference object / file',
          value_type: 'text',
          validation: {
            max_length: 128,
          },
        ...
        {
          key: 'illumination_source',
          label_zh: '光源',
          label_en: 'Illumination source used',
          value_type: 'text',
          validation: {
            max_length: 128,
          },
        ...
        {
          key: 'illumination_setting',
          label_zh: '光源设置',
          label_en: 'Illumination setting and instrument unit',
          value_type: 'text',
          validation: {
            max_length: 128,
          },
        ...
        {
          key: 'aperture_setting',
          label_zh: '孔径光阑',
          label_en: 'Illumination aperture setting',
          value_type: 'text',
          validation: {
            max_length: 128,
          },
        ...
        {
          key: 'image_scale_y_um_per_px',
          label_zh: 'Y 像素尺度',
          label_en: 'Y pixel scale',
          value_type: 'number',
          unit: 'μm/px',
          when: {
            observation_mode: ['digital'],
        ...
        },
        {
          ...
          label_zh: '像素尺度校准依据',
          label_en: 'Image / diffraction scale calibration source',
          value_type: 'text',
          validation: {
            max_length: 128,
          },
        ...
        },
        {
          key: 'image_bit_depth',
          label_zh: '图像有效位深',
          label_en: 'Image significant bit depth',
          value_type: 'integer',
          validation: {
            ge: 1,
            le: 64,
        ...
        {
          key: 'camera_offset',
          label_zh: '相机黑电平/偏置及单位',
          label_en: 'Camera black level / offset and unit',
          value_type: 'text',
          validation: {
            max_length: 128,
          },
        ...
        },
        {
          ...
          label_zh: '图像处理/合成及配置',
          label_en: 'Image processing / compositing settings',
          value_type: 'text',
          validation: {
            max_length: 1000,
          },
        ...
        {
          key: 'incident_polarization_state',
          label_zh: '入射偏振状态',
          label_en: 'Incident polarization state',
          value_type: 'select',
          options: [
            {
              value: 'linear',
    ...
    Raman: {
      ...
      show_growth_presence: false,
      raw_file_guidance_zh: '上传原始光谱或仪器采集文件。',
      ...
      condition_fields: [
        ...
        {
          key: 'collection_geometry_other',
          label_zh: '其他收集几何',
          label_en: 'Other collection geometry',
          value_type: 'text',
          validation: {
            max_length: 128,
          },
          when: {
            collection_geometry: ['other'],
          },
          required_when: {
            collection_geometry: ['other'],
          },
        ...
        {
          key: 'acquisition_kind',
          label_zh: '采集形式',
          label_en: 'Acquisition type',
          value_type: 'select',
          options: [
            {
              value: 'single',
            ...
            },
            {
              value: 'series',
              label_zh: '时间/参数序列',
              label_en: 'Time / parameter series',
            },
          ],
        },
        {
        ...
        },
        {
          ...
          options: [
            ...
            {
              value: 'stage_setpoint',
              label_zh: '样品台设定',
              label_en: 'Stage setpoint',
            },
            {
              value: 'sample_measured',
              label_zh: '样品实测',
        ...
        },
        {
          key: 'filter_cutoff',
          label_zh: '低频范围及依据',
          label_en: 'Low-frequency range and reference',
          value_type: 'text',
          validation: {
            max_length: 128,
          },
        ...
        {
          key: 'wavenumber_calibration',
          label_zh: '位移校准记录',
          label_en: 'Raman shift calibration record',
          value_type: 'text',
          validation: {
            max_length: 1000,
          },
    ...
    AFM: {
      ...
      condition_fields: [
        ...
        },
        {
          key: 'scan_rate_hz',
          label_zh: '扫描线频率',
          label_en: 'Scan line rate',
          value_type: 'number',
          unit: 'Hz',
          help_zh: '按仪器定义记录；线/秒或往返/秒的口径在扫描频率定义中说明。',
          help_en:
            'Use the instrument definition and specify lines/s or round trips/s below.',
        },
        {
        ...
        {
          key: 'scan_rate_definition',
          label_zh: '扫描频率定义',
          label_en: 'Scan rate definition',
          value_type: 'text',
          validation: {
            max_length: 128,
          },
        },
        {
          key: 'data_channel',
          label_zh: '数据通道/文件内序列',
          label_en: 'Data channel / series in file',
          value_type: 'text',
          validation: {
            max_length: 128,
          },
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              value: 'both',
              label_zh: '正反向',
              label_en: 'Trace and retrace',
            },
          ],
        },
        {
          key: 'scan_rotation_deg',
          label_zh: '快扫描轴角度',
          label_en: 'Fast scan axis angle',
          value_type: 'number',
          unit: '°',
          validation: {
            ge: -360,
        ...
        {
          key: 'feedback_setpoint',
          label_zh: '反馈设定值及单位',
          label_en: 'Feedback setpoint and unit',
          value_type: 'text',
          validation: {
            max_length: 128,
          },
        ...
        },
        {
          key: 'free_amplitude',
          label_zh: '自由振幅及单位',
          label_en: 'Free amplitude and unit',
          value_type: 'text',
          validation: {
            max_length: 128,
          },
          when: {
            mode: ['tapping', 'non_contact'],
          },
        },
        {
          key: 'feedback_gains',
          label_zh: '反馈增益/原机配置',
          label_en: 'Feedback gains / instrument configuration',
          value_type: 'text',
          validation: {
            max_length: 128,
          },
        ...
        {
          key: 'drive_frequency_kHz',
          label_zh: '驱动频率',
          label_en: 'Drive frequency',
          value_type: 'number',
          unit: 'kHz',
        },
        {
          key: 'height_calibration',
          label_zh: 'Z 高度校准来源',
          label_en: 'Z-height calibration source',
          value_type: 'text',
          validation: {
            max_length: 128,
          },
    ...
    SEM: {
      ...
      optional_condition_keys: [
        ...
        'eds_live_time_s',
        'eds_real_time_s',
        'eds_dead_time_percent',
        'eds_process_time',
        'eds_energy_range',
        'energy_dispersion_eV_channel',
        'vacuum_mode',
        'chamber_pressure_Pa',
        'beam_current_setting',
        'acquisition_note',
      ],
      condition_fields: [
        {
        ...
        {
          key: 'pixel_dwell_time_us',
          label_zh: '每像素驻留时间',
          label_en: 'Pixel dwell time',
          value_type: 'number',
          unit: 'μs',
        },
        {
          key: 'frame_count',
          label_zh: '采集帧数',
          label_en: 'Acquired frames',
          value_type: 'integer',
        },
        {
          key: 'frame_combination',
          label_zh: '多帧处理',
          label_en: 'Frame combination',
          value_type: 'select',
          options: [
            {
              value: 'sum',
        ...
        },
        {
          ...
          label_zh: '导电层/镀层材料',
          label_en: 'Conductive coating material',
          value_type: 'text',
          validation: {
            max_length: 128,
          },
        },
        {
          ...
          label_zh: '已知镀层厚度',
          label_en: 'Known coating thickness',
          value_type: 'number',
          unit: 'nm',
          validation: {
            ge: 0,
        ...
        {
          key: 'spectrum_acquisition',
          label_zh: '能谱采集形式',
          label_en: 'Spectroscopy acquisition',
          value_type: 'select',
          options: [
            {
              value: 'single',
              label_zh: '单谱',
              label_en: 'Single spectrum',
            },
            {
              value: 'line',
              label_zh: '线扫描',
        ...
        {
          key: 'eds_dead_time_percent',
          label_zh: 'EDS 死时间占比',
          label_en: 'EDS dead time',
          value_type: 'number',
          unit: '%',
          validation: {
            ge: 0,
        ...
        {
          key: 'eds_process_time',
          label_zh: 'EDS 脉冲处理时间/档位',
          label_en: 'EDS pulse process time / setting',
          value_type: 'text',
          validation: {
            max_length: 128,
          },
        ...
        {
          key: 'eds_energy_range',
          label_zh: 'EDS 能量范围及单位',
          label_en: 'EDS energy range and unit',
          value_type: 'text',
          validation: {
            max_length: 128,
          },
        ...
        {
          key: 'energy_dispersion_eV_channel',
          label_zh: '能量轴采样间隔',
          label_en: 'Energy dispersion',
          value_type: 'number',
          unit: 'eV/channel',
          when: {
            mode: ['EDS'],
        ...
        },
        {
          key: 'vacuum_mode',
          label_zh: '腔体真空模式',
          label_en: 'Chamber vacuum mode',
          value_type: 'select',
          options: [
            {
              value: 'high_vacuum',
              label_zh: '高真空',
              label_en: 'High vacuum',
            },
            {
              value: 'low_vacuum',
              label_zh: '低真空',
        ...
        {
          key: 'chamber_pressure_Pa',
          label_zh: '测量腔体压力',
          label_en: 'Chamber pressure',
          value_type: 'number',
          unit: 'Pa',
        },
        {
          key: 'beam_current_setting',
          label_zh: '束流档位/读数来源',
          label_en: 'Beam current setting / reading source',
          value_type: 'text',
          validation: {
            max_length: 128,
          },
    ...
    XRD: {
      ...
      condition_fields: [
        ...
        },
        {
          key: 'axis_coupling',
          label_zh: '扫描轴耦合',
          label_en: 'Scan axis coupling',
          value_type: 'select',
          options: [
            {
              value: 'theta_two_theta',
              label_zh: 'θ–2θ 联动',
              label_en: 'Coupled θ–2θ',
            },
            {
              value: 'omega_two_theta',
              label_zh: 'ω–2θ 联动',
              label_en: 'Coupled ω–2θ',
            },
            {
              value: 'uncoupled',
              label_zh: '单轴独立扫描',
              label_en: 'Uncoupled single axis',
            },
            {
              value: 'other',
              label_zh: '其他程序',
              label_en: 'Other program',
            },
          ],
        },
        {
          key: 'fixed_two_theta_deg',
          label_zh: '固定 2θ',
          label_en: 'Fixed 2θ',
          value_type: 'number',
          unit: '°',
        ...
        {
          key: 'scan_reference',
          label_zh: '角度零点/非扫描轴设置',
          label_en: 'Angular reference / fixed axis settings',
          value_type: 'text',
          validation: {
            max_length: 128,
          },
        ...
        {
          key: 'xray_optics',
          label_zh: '实际单色器/滤片/狭缝配置',
          label_en: 'Monochromator / filter / slit configuration',
          value_type: 'text',
          validation: {
            max_length: 128,
          },
        ...
        },
        {
          key: 'tube_current_mA',
          label_zh: 'X 射线管电流',
          label_en: 'X-ray tube current',
          value_type: 'number',
          unit: 'mA',
        },
        {
          key: 'xrd_processing',
          label_zh: '背景/零点/仪器展宽处理',
          label_en: 'Background / zero / instrumental broadening treatment',
          value_type: 'text',
          validation: {
            max_length: 1000,
          },
    ...
    TEM: {
      ...
      optional_condition_keys: [
        ...
        'camera_length',
        'diffraction_aperture',
        'eels_energy_range',
        'eels_collection_semiangle_mrad',
        'zero_loss_calibration',
        'acquisition_note',
      ],
      condition_fields: [
        {
        ...
        },
        {
          key: 'defocus_nm',
          label_zh: '离焦量（原机符号）',
          label_en: 'Defocus (instrument sign)',
          value_type: 'number',
          unit: 'nm',
          validation: {
            ge: -1000000,
        ...
        },
        {
          ...
          label_zh: '像差校正/物镜配置',
          label_en: 'Aberration correction / objective configuration',
          value_type: 'text',
          validation: {
            max_length: 128,
          },
        ...
        {
          key: 'convergence_semiangle_mrad',
          label_zh: '电子束收敛半角',
          label_en: 'Beam convergence semi-angle',
          value_type: 'number',
          unit: 'mrad',
        },
        {
          key: 'collection_inner_mrad',
          label_zh: '探测器内收集半角',
          label_en: 'Detector inner collection semi-angle',
          value_type: 'number',
          unit: 'mrad',
          validation: {
            ge: 0,
        ...
        {
          key: 'collection_outer_mrad',
          label_zh: '探测器外收集半角',
          label_en: 'Detector outer collection semi-angle',
          value_type: 'number',
          unit: 'mrad',
          when: {
            acquisition_mode: ['STEM'],
        ...
        },
        {
          key: 'camera_length',
          label_zh: '相机长度/原机档位',
          label_en: 'Camera length / instrument setting',
          value_type: 'text',
          validation: {
            max_length: 128,
          },
          when: {
            data_type: ['diffraction', 'spectrum'],
          },
        },
        {
          key: 'diffraction_aperture',
          label_zh: '衍射光阑/束斑配置',
          label_en: 'Diffraction aperture / probe configuration',
          value_type: 'text',
          validation: {
            max_length: 128,
          },
        ...
        {
          key: 'eels_energy_range',
          label_zh: 'EELS 能量损失范围及单位',
          label_en: 'EELS energy-loss range and unit',
          value_type: 'text',
          validation: {
            max_length: 128,
          },
        ...
        {
          key: 'eels_collection_semiangle_mrad',
          label_zh: 'EELS 收集半角',
          label_en: 'EELS collection semi-angle',
          value_type: 'number',
          unit: 'mrad',
          when: {
            spectrum_mode: ['EELS'],
        ...
        {
          key: 'zero_loss_calibration',
          label_zh: '零损失峰/能量校准来源',
          label_en: 'Zero-loss peak / energy calibration source',
          value_type: 'text',
          validation: {
            max_length: 128,
          },
    ...
    other: {
      ...
      optional_condition_keys: ['sample_preparation', 'acquisition_note'],
      condition_fields: [
        {
    ...
    SHG: {
      ...
      condition_fields: [
        ...
        },
        {
          ...
          recommended: true,
          help_zh: '实验室零点与正方向；不要求填写晶体学取向。',
          help_en:
            'Laboratory zero and positive direction; no crystallographic assignment required.',
        },
        {
