...
export const characterizationProfiles: Record<string, CharacterizationProfile> =
  {
    optical_microscopy: {
      ...
      condition_fields: [
        ...
        },
        {
          ...
          label_zh: '物镜浸没介质',
          label_en: 'Objective immersion medium',
          value_type: 'text',
          validation: {
            max_length: 128,
          },
        ...
        },
        {
          ...
          when: {
            white_balance_mode: ['manual', 'one_shot', 'continuous_auto'],
          },
          recommended: true,
        },
        {
    ...
    Raman: {
      ...
      condition_fields: [
        ...
        {
          key: 'filter_cutoff',
          label_zh: '实际可测低频范围/截止依据',
          label_en: 'Accessible low-frequency range / filter cutoff source',
          value_type: 'text',
          validation: {
            max_length: 128,
          },
