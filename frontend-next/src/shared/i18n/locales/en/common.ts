...
export const common = {
  ...
  validation: {
    ...
    structuredField: 'Check required entries and values in “{{field}}”',
    ...
    instrumentCapabilities:
      'Select supported methods; other method names are required and must be unique.',
  ...
  structuredFields: {
    ...
    uprightGrowthFaceDirection: 'Growth-face direction when upright',
    towardDownstream: 'Toward downstream',
    towardUpstream: 'Toward upstream',
    towardTubeLeft: 'Toward tube left',
    towardTubeRight: 'Toward tube right',
    quartzBoat: 'Quartz boat',
    aluminaBoat: 'Alumina boat',
    otherMaterial: 'Other material',
    length: 'Length (mm)',
    width: 'Width (mm)',
    longEdge: 'Long edge (mm)',
    shortEdge: 'Short edge (mm)',
    height: 'Height (mm)',
    ...
    temperature: 'Actual temperature at this position (°C)',
    temperatureBasis: 'Temperature basis',
    setpoint: 'Setpoint',
    measured: 'Measured value',
    estimate: 'Estimate',
    notProvided: 'Not provided',
    distance: 'Position relative to temperature measurement point (mm)',
  ...
  structuredEditors: {
    treatmentSteps: {
      ...
      selectType: 'Select a treatment method',
      ...
      options: {
        ...
        wipe: 'Wipe',
        other: 'Other',
        not_recorded: 'Not recorded in legacy data',
      },
      types: {
      ...
      fields: {
        ...
        pressure_MPa: 'Pelletizing pressure',
        die_diameter_mm: 'Die diameter',
        solvent: 'Solvent',
        solvent_other: 'Other solvent name',
    ...
    coolingParams: {
      ...
      methods: {
        ...
        rapid_furnace_move_cooling: 'Cooling by moving the furnace',
  ...
  entityLibrary: {
    ...
    form: {
      ...
      clearOtherMethods:
        'Unchecking Other clears the entered method names. Continue?',
      ...
      unboundFileHint: 'Save the details to associate the attachment.',
  ...
  characterizations: {
    ...
    run: {
      ...
      readOnlyTitle: 'View characterization records',
      subtitle:
    ...
    list: {
      ...
      subtitle:
        'Review every visible sample with its characterization records, including samples awaiting results.',
      ...
      empty:
        'No samples are ready for characterization. Submit a preparation record to generate samples first.',
    ...
    details: {
      invalidateSuccess: 'Characterization record marked invalid',
      invalidateError: 'Failed to invalidate characterization record',
      downloadError: 'Failed to download raw file',
      loadError: 'Failed to load characterization details',
      retry: 'Retry',
      snapshotRecorded: 'Instrument recorded',
      noInstrument: 'Instrument not recorded',
      title: 'Measurement details',
      revision: 'Revision v{{version}}',
      quality: { valid: 'Valid', suspect: 'Suspect', invalid: 'Invalid' },
      propertyQuality: {
        valid: 'Valid',
      ...
      historicalAssignments: 'Historical assignments (not measured values)',
      noStructuredResults: 'No structured result was recorded.',
      rawFiles: 'Raw files',
      ...
      download: 'Download',
      deletedFile: 'Deleted',
      noFiles: 'No raw files.',
      analysis: 'Analysis provenance',
      analysisParameters: 'Analysis parameters',
      noAnalysisParameters: 'No analysis parameters recorded.',
      analysisInputs: 'Input files',
      analysisOutputs: 'Output files',
      ...
      detectionLimitBasis: 'Detection-limit basis: {{value}}',
      analysisRun: 'Data processing record: {{analysis}}',
      statistic: 'Statistic type: {{value}}',
      uncertainty: 'Uncertainty: {{value}} ({{type}})',
      sampleCount: 'Sample count: {{count}}',
      confidence: 'Confidence: {{value}}',
      noAnalysisFiles: 'No files recorded.',
      fileMetadataLoading: 'Loading file metadata…',
      fileMetadataUnavailable: 'File metadata unavailable',
      ...
      regionValues: {
        ...
        line: 'Line',
        area: 'Area',
        sample_local: 'Sample-local coordinates',
        image_pixel: 'Image-pixel coordinates',
        stage_coordinate: 'Stage coordinates',
      },
      assertionTypes: {
        growth_presence: 'Growth observation',
        phase_identity: 'Phase assignment',
        stacking_order: 'Stacking assignment',
        layer_count: 'Layer-count assignment',
        polytype: 'Polytype assignment',
        composition: 'Composition assignment',
        orientation_relationship: 'Orientation relationship assignment',
      },
      assertionFields: {
        state: 'Observation',
        phase: 'Phase',
        ...
        species: 'Species',
        fraction: 'Fraction',
        orientation_relationship: 'Orientation relationship',
      },
      assertionValues: {
        present: 'Growth observed',
        absent: 'No growth observed',
        uncertain: 'Uncertain',
      },
      assertionValidity: {
        active: 'Active',
      ...
      invalidationReason: 'Invalidation reason: {{reason}}',
      invalidatedBy: 'Invalidated by',
      invalidatedAt: 'Invalidated at',
      noReason: 'Not recorded',
      invalidateAction: 'Mark this record invalid',
      invalidateTitle: 'Invalidate characterization record',
      invalidateDescription:
        'The original record remains in the audit trail. Add a replacement record after invalidating it.',
      reason: 'Invalidation reason',
      reasonHelp: 'Required, up to 2,000 characters.',
      cancel: 'Cancel',
      invalidating: 'Invalidating…',
      confirmInvalidate: 'Confirm invalidation',
    },
    workspace: {
      peaks: {
        title: 'Spectral peaks',
        status: 'Peak extraction status',
        recorded: 'Peaks extracted',
        not_detected: 'No resolvable peaks detected',
        not_analyzed: 'Not analyzed',
        positionUnit: 'Peak position unit',
        ...
        d_spacing_nm: 'd-spacing',
        intensityUnit: 'Intensity unit',
        processing: 'Data processing',
        extractionMethod: 'Peak extraction or fit method',
        baselineMethod: 'Baseline processing',
        sourceRequired: 'Select the source spectrum',
        peakRequired: 'Add at least one peak',
        invalidPeak:
          'Check peak parameters: position is required, widths and spacings must be positive, and intensities cannot be negative',
        clearPeaks:
          'Marking no peaks detected will clear the entered peaks. Continue?',
        changeUnit:
          'Changing position units will clear the peaks without converting values. Continue?',
        changeIntensityUnit:
          'Changing intensity units will clear peak heights and areas. Continue?',
      },
      title: 'Add characterization record',
      readOnlyTitle: 'Existing characterization records (read-only)',
      resultSourceHelp: 'Results must be traceable to the uploaded files.',
      sections: {
        selection: '1. Select sample and method',
        measurement: '2. Instrument and measurement',
        rawData: '3. Upload data files',
        results: '4. Enter key results',
        save: '5. Save characterization record',
        existing: 'Existing characterization records',
      },
      fields: {
        sample: 'Sample',
        method: 'Characterization method',
        ...
        regionGeometry: 'Region type',
        regionLabel: 'Region label',
        regionX: 'X coordinate',
        regionY: 'Y coordinate',
        regionLength: 'Line length',
        regionWidth: 'Width',
        regionHeight: 'Height',
        regionUnit: 'Coordinate or size unit',
        regionImage: 'Region image',
        pixelRoiX: 'Pixel ROI X',
        pixelRoiY: 'Pixel ROI Y',
        pixelRoiWidth: 'Pixel ROI width',
        ...
        confidence: 'Conclusion confidence (0–1)',
        rawFiles: 'Data files',
        rawFile: 'Raw file',
      ...
      placeholders: {
        ...
        method: 'Select a characterization method',
        instrumentVersion: 'Select an instrument version',
        location: 'Select a measurement location',
        select: 'Select',
      ...
      actions: {
        retry: 'Retry',
        save: 'Save characterization record',
        saving: 'Saving…',
        moreConditions: 'Other acquisition settings',
        moreResults: 'Other measured results',
        resultMetadata: 'Statistics and uncertainty',
        removeFile: 'Remove file {{filename}}',
        viewDetails: 'View details',
        hideDetails: 'Hide details',
      },
      errors: {
        samples: 'Failed to load samples',
      ...
      toast: {
        ...
        saveError: 'Failed to save characterization record',
      },
      confirm: {
        leave:
        ...
        methodChange:
          'Changing the method clears unsaved values for this method. Continue?',
      },
      missing: {
        title: 'Still required:',
        sample: 'Select a sample',
        method: 'Select a characterization method',
        measuredAt: 'Select a measurement time',
        location: 'Enter a location description',
        locationMax: 'Location description cannot exceed {{max}} characters',
        regionLabel: 'Enter a region label',
        regionLabelMax: 'Region label cannot exceed {{max}} characters',
        coordinatePair: 'Enter both X and Y coordinates',
        invalidCoordinate: 'Enter valid coordinate or size values',
        lineLength: 'Enter a line length greater than 0',
        areaSize: 'Enter width and height greater than 0',
        ...
        qualityNote: 'Enter the detection-limit basis',
        sampleCount:
        ...
        pixelRoi:
          'Complete the pixel ROI with integer X and Y of at least 0 and positive width and height',
        instrument: 'Select an instrument',
        instrumentVersion: 'Select an instrument version',
        instrumentUnsupported:
          'The selected instrument version does not support this method',
        rawFile: 'Upload a raw file',
        evidence: 'Upload a raw file or enter at least one key result',
      },
      validation: {
        required: '{{label}} is required',
        textMin: '{{label}} must contain at least {{min}} characters',
        textMax: '{{label}} cannot exceed {{max}} characters',
        invalidNumber: '{{label}} must be a valid number',
        nonNegativeInteger: '{{label}} must be a non-negative integer',
        ge: '{{label}} cannot be less than {{value}}',
        gt: '{{label}} must be greater than {{value}}',
        le: '{{label}} cannot be greater than {{value}}',
        lt: '{{label}} must be less than {{value}}',
        conditionRequired: 'This field is required.',
        completeValues: 'Complete every value.',
        conditionTextMin: 'Enter at least {{min}} characters.',
        conditionTextMax: 'Cannot exceed {{max}} characters.',
        conditionNumber: 'Enter a valid number.',
        positiveInteger: 'Enter an integer of at least 1.',
        range: 'The end must exceed the start.',
        positiveNumber: 'Enter a number greater than 0.',
        conditionOption: 'Select a valid option.',
        conditionRange: 'Enter a value from {{min}} to {{max}}.',
        powerValue: 'Enter the power value.',
        powerBasis: 'Select the power unit.',
      },
      advanced: {
        title: 'Additional data and processing',
        composition: 'Elemental quantification',
        assertions: 'Material conclusions',
        compositionBasis: 'Fraction basis',
        compositionBasisValues: {
          site_fraction: 'Site fraction',
          atomic_fraction: 'Atomic fraction',
          mass_fraction: 'Mass fraction',
        },
        addComposition: 'Add element',
        removeComposition: 'Remove component {{index}}',
        remove: 'Remove',
        species: 'Element symbol',
        fraction: 'Fraction (0–1)',
        compositionSpecies: 'Enter valid element symbols',
        compositionFraction:
        ...
        analysis: 'Data processing record',
        analysisHelp:
          'Entered results will be linked to this processing record.',
        softwareName: 'Software name',
        softwareVersion: 'Software version',
        startedAt: 'Analysis started at',
        completedAt: 'Analysis completed at',
        ...
        outputFileLabel: 'Use {{filename}} as an analysis output',
        noInputFiles: 'Upload data files first.',
        noRegionImages: 'Upload an image file above to record a pixel region.',
        outputFilesHelp: 'A file cannot be both an input and an output.',
        analysisSoftware:
          'Software name is required and cannot exceed 128 characters',
        analysisVersion:
          'Software version is required and cannot exceed 128 characters',
      ...
      results: {
        growth: 'Was growth observed?',
        phase: 'Phase',
        layers: 'Layer-count conclusion',
        stacking: 'Stacking conclusion',
      },
      propertyQuality: {
        valid: 'Valid',
        below_detection_limit: 'Below detection limit',
      ...
      measurementQuality: {
        ...
        suspect: 'Suspect',
        invalid: 'Invalid',
        help: 'Suspect records remain auditable but do not update sample conclusions or complete result tasks. To invalidate a record, open its details and provide a reason.',
      },
      locations: {
        whole_sample: 'Whole sample',
        center: 'Center',
      ...
      rawFileGuidance: 'Upload the raw data file produced by the instrument.',
      selectMethodFirst: 'Select a characterization method first',
      emptySamples: 'No samples are available for characterization.',
      noPresetResults:
        'This method has no preset result fields. Upload raw data to complete the record.',
      detailRegion: 'Characterization details for {{sample}}',
      noMeasurements: 'This experiment has no characterization records yet.',
    },
  },
  ...
  experimentsV2: {
    ...
    form: {
      ...
      saveModule: 'Save current step',
      moduleSaved: 'Saved',
      moduleSaveSuccess: 'Current step saved',
    ...
    sections: {
      ...
      results: {
        ...
        parameterUnit: 'Condition unit',
        additionalConditionNote: 'Additional test-condition note',
        conditionFields: {
