  ...
  experimentsV2: {
    ...
    sections: {
      ...
      results: {
        ...
        rawDataHint: 'Raw-data file upload is wired later (placeholder).',
        ...
        phaseStacking: 'Detected phase / polytype / stacking',
        layersCoverage: 'Measured layer count / coverage',
        domain: 'Domain size / nucleation density / continuity',
        spectral: 'Key spectroscopic metrics',
