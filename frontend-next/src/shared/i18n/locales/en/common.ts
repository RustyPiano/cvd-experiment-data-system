...
export const common = {
  ...
  structuredFields: {
    ...
    distance: 'Position relative to thermocouple (mm)',
  ...
  characterizations: {
    ...
    details: {
      ...
      retry: 'Retry',
      snapshotRecorded: 'Instrument snapshot recorded',
      noInstrument: 'No instrument used',
    ...
    workspace: {
      ...
      fields: {
        ...
        location: 'Measurement location (optional)',
        locationNote: 'Location description',
        regionGeometry: 'Region type',
        regionLabel: 'Region label',
        regionX: 'X coordinate (optional)',
        regionY: 'Y coordinate (optional)',
      ...
      advanced: {
        ...
        addComposition: 'Add component',
        removeComposition: 'Remove component {{index}}',
        remove: 'Remove',
        species: 'Species',
        fraction: 'Fraction (0–1)',
        compositionSpecies:
          'Every component requires a species of at most 128 characters',
        compositionFraction:
        ...
        noInputFiles: 'Select raw files above first.',
        noRegionImages: 'Upload an image file above to record a pixel region.',
        outputFilesHelp:
          'Output files are uploaded as processed data; one file cannot be both an input and an output.',
        analysisSoftware:
      ...
      selectedFiles: 'Selected raw files',
      ...
      emptySamples: 'No active sample is available for the current revision.',
      noPresetResults:
